  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group peer hidden md:flex flex-col flex-shrink-0 text-sidebar-foreground transition-[width] duration-200 ease-linear",
          "w-[--sidebar-width]",
          // offcanvasモードでcollapsed状態の時は非表示
          "data-[state=collapsed]:data-[collapsible=offcanvas]:hidden",
          // iconモードの時は幅を縮小
